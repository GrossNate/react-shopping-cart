...
interface ProductsRowProps
  extends CatalogItem,
    Pick<ProductsProps, 'onAddItem' | 'onEditItem' | 'onDeleteProduct'> {}
    ...
    <li className="product">
      <div className="product-details">
        ...
        <div className="actions product-actions">
          ...
          <button className="edit" onClick={toggleShowEditProduct}>
            Edit
          </button>
        </div>
...
interface EditProductProps
  extends Omit<ProductsRowProps, 'onAddItem' | 'onDeleteProduct'> {
...
export const EditProduct = ({
  ...
  const [productDetails, setProductDetails] = useState<CatalogItem>({
    _id,
    title,
    quantity,
    price,
  ...
  const set = (
    ...
    return ({ target: { value } }) =>
      setProductDetails((details) => ({ ...details, [fieldName]: value }));
  };
